...
class Environment:
    ...
    invader_set = [invaders, invaders1, invaders2, invaders3]

    for inv in invader_set:
        if inv.colour == (0,0,255):
            inv.image = pygame.image.load("Invader .png").convert()
        elif inv.color == (0, 255, 0):
            inv.image = pygame.image.load("Invader 1.png").convert()
        else:
            inv.image = self.image = pygame.image.load("Asset 1.png").convert()
